...
render(){
    return (
      ...
      <div className="box" id="boxG" style={{background:this.state.colors,height:"520px"}}><h5 className="font-weight-bold text-light px-5 py-5" style={{fontFamily:this.state.fnts,fontSize:this.state.textSizes+"px",alignItems:"center",justifyContent: "center",textShadow:"2px 2px 8px #000000",display: "flex"}}>{this.state.textData}</h5></div><br/>
      ...
      <Button variant="outline-dark" onClick={this.SelectFont}>fonts</Button>
