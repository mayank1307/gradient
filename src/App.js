...
DecText=()=>{
  ...
  render(){
    return (
      <div>
      <div className="box" id="boxG" style={{background:this.state.colors,height:"480px"}}><h5 className="font-weight-bold text-light px-5 py-5" style={{fontSize:this.state.textSizes+"px",alignItems:"center",justifyContent: "center",textShadow:"2px 2px 8px #000000",display: "flex"}}>{this.state.textData}</h5></div><br/>
