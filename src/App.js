...
class App extends React.Component {
  constructor(){
    ...
    this.state={
      NumberHolder:0,
      dirC:0,
      text:"hi there its been a rough day",
      value: '',
      copied: false,
  ...
  return (
    <div className="App mx-4 my-4">
      <div className="box" id="boxG" style={{background:this.state.colors,height:"450px"}}><h5 className="font-weight-bold text-light px-5 py-5" style={{fontSize:"2em"}}>{this.state.text}</h5></div><br/>
      ...
      <Button className="mx-1 px-3" variant="outline-dark" onClick={this.ImageC}><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M17 13v-13h-2v5h-2v-3h-2v7h-2v-9h-2v13h-6l11 11 11-11z"/></svg></Button>
