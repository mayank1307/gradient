...
class App extends React.Component {
  ...
  return (
    <div className="App mx-4 my-4">
      <div className="box" id="boxG" style={{background:this.state.colors,height:"450px"}}><h5 className="font-weight-bold text-light px-5 py-5" style={{fontSize:"2em"}}>{this.state.textData}</h5></div><br/>
      ...
      <InputGroup className="mx-1 my-1 col-6">
        <FormControl placeholder="Add text" aria-label="textUi" id="textBox" aria-describedby="basic-addon2"/>
        <InputGroup.Append><Button onClick={this.ChangeText} variant="success">Change Text</Button></InputGroup.Append>
        <InputGroup.Append><Button onClick={this.DeleteText} variant="danger">Delete Text</Button></InputGroup.Append>
      </InputGroup>
