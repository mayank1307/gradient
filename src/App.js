...
class App extends React.Component {
  ...
  return (
    <div className="App mx-4 my-4">
      <div className="box" id="boxG" style={{background:this.state.colors,height:"450px"}}><h5 className="font-weight-bold text-light px-5 py-5" style={{fontSize:this.state.textSizes+"px",alignItems:"center",justifyContent: "center",display: "flex"}}>{this.state.textData}</h5></div><br/>
